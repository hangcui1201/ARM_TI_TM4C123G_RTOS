...
override PKGDIR = xconfig_multi_task_thread
...
package/%.xdc.inc package/%_xconfig_multi_task_thread.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_multi_task_thread" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: multi_task_thread.pem4f

-include package/cfg/multi_task_thread_pem4f.mak
-include package/cfg/multi_task_thread_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/multi_task_thread_pem4f.dep
endif
multi_task_thread.pem4f: package/cfg/multi_task_thread_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
multi_task_thread.pem4f package/cfg/multi_task_thread_pem4f.c: .libraries,em4f
endif

package/cfg/multi_task_thread_pem4f.c package/cfg/multi_task_thread_pem4f.h package/cfg/multi_task_thread_pem4f.xdl: override _PROG_NAME := multi_task_thread.xem4f
package/cfg/multi_task_thread_pem4f.c: package/cfg/multi_task_thread_pem4f.cfg
package/cfg/multi_task_thread_pem4f.xdc.inc: package/cfg/multi_task_thread_pem4f.xdl
package/cfg/multi_task_thread_pem4f.xdl package/cfg/multi_task_thread_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/multi_task_thread_pem4f.cfg
	-$(RM) package/cfg/multi_task_thread_pem4f.dep
	-$(RM) package/cfg/multi_task_thread_pem4f.c
	-$(RM) package/cfg/multi_task_thread_pem4f.xdc.inc

clean,em4f::
	-$(RM) multi_task_thread.pem4f
.executables,em4f .executables: multi_task_thread.xem4f

multi_task_thread.xem4f: |multi_task_thread.pem4f

-include package/cfg/multi_task_thread.xem4f.mak
multi_task_thread.xem4f: package/cfg/multi_task_thread_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/multi_task_thread_pem4f.oem4f   package/cfg/multi_task_thread_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
multi_task_thread.xem4f: export C_DIR=
multi_task_thread.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
multi_task_thread.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

multi_task_thread.test test,em4f test: multi_task_thread.xem4f.test

multi_task_thread.xem4f.test:: multi_task_thread.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 multi_task_thread.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.multi_task_thread.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,multi_task_thread.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) multi_task_thread.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
multi_task_thread_pem4f.oem4f,copy : package/cfg/multi_task_thread_pem4f.oem4f
multi_task_thread_pem4f.sem4f,copy : package/cfg/multi_task_thread_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_multi_task_thread
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_multi_task_thread.tar.dep
endif
package/rel/xconfig_multi_task_thread/xconfig_multi_task_thread/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_multi_task_thread/xconfig_multi_task_thread/package/package.rel.xml: package/build.cfg
package/rel/xconfig_multi_task_thread/xconfig_multi_task_thread/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_multi_task_thread/xconfig_multi_task_thread/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_multi_task_thread.tar: package/rel/xconfig_multi_task_thread.xdc.inc package/rel/xconfig_multi_task_thread/xconfig_multi_task_thread/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_multi_task_thread.xdc.inc,package/rel/xconfig_multi_task_thread.tar.dep)


release release,xconfig_multi_task_thread: all xconfig_multi_task_thread.tar
clean:: .clean
	-$(RM) xconfig_multi_task_thread.tar
	-$(RM) package/rel/xconfig_multi_task_thread.xdc.inc
	-$(RM) package/rel/xconfig_multi_task_thread.tar.dep
