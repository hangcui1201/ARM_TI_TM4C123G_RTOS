...
linker.cmd: package/cfg/task_thread_dynamic_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/task_thread_dynamic_pem4fcfg.cmd\)\"$""\"C:/Github_Repo/ARM_TI_TM4C123G_RTOS/workspace/task_thread_dynamic/.config/xconfig_task_thread_dynamic/\1\""' package/cfg/task_thread_dynamic_pem4f.xdl > $@
