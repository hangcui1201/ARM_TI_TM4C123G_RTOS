...
override PKGDIR = xconfig_semaphores_deadlock
...
ti.targets.arm.elf.M4F.rootDir ?= C:/ti/ccs920/ccs/tools/compiler/ti-cgt-arm_18.12.4.LTS
...
package/%.xdc.inc package/%_xconfig_semaphores_deadlock.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_semaphores_deadlock" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: semaphores_deadlock.pem4f

-include package/cfg/semaphores_deadlock_pem4f.mak
-include package/cfg/semaphores_deadlock_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/semaphores_deadlock_pem4f.dep
endif
semaphores_deadlock.pem4f: package/cfg/semaphores_deadlock_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
semaphores_deadlock.pem4f package/cfg/semaphores_deadlock_pem4f.c: .libraries,em4f
endif

package/cfg/semaphores_deadlock_pem4f.c package/cfg/semaphores_deadlock_pem4f.h package/cfg/semaphores_deadlock_pem4f.xdl: override _PROG_NAME := semaphores_deadlock.xem4f
package/cfg/semaphores_deadlock_pem4f.c: package/cfg/semaphores_deadlock_pem4f.cfg
package/cfg/semaphores_deadlock_pem4f.xdc.inc: package/cfg/semaphores_deadlock_pem4f.xdl
package/cfg/semaphores_deadlock_pem4f.xdl package/cfg/semaphores_deadlock_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/semaphores_deadlock_pem4f.cfg
	-$(RM) package/cfg/semaphores_deadlock_pem4f.dep
	-$(RM) package/cfg/semaphores_deadlock_pem4f.c
	-$(RM) package/cfg/semaphores_deadlock_pem4f.xdc.inc

clean,em4f::
	-$(RM) semaphores_deadlock.pem4f
.executables,em4f .executables: semaphores_deadlock.xem4f

semaphores_deadlock.xem4f: |semaphores_deadlock.pem4f

-include package/cfg/semaphores_deadlock.xem4f.mak
semaphores_deadlock.xem4f: package/cfg/semaphores_deadlock_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/semaphores_deadlock_pem4f.oem4f   package/cfg/semaphores_deadlock_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
semaphores_deadlock.xem4f: export C_DIR=
semaphores_deadlock.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
semaphores_deadlock.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

semaphores_deadlock.test test,em4f test: semaphores_deadlock.xem4f.test

semaphores_deadlock.xem4f.test:: semaphores_deadlock.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 semaphores_deadlock.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.semaphores_deadlock.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,semaphores_deadlock.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) semaphores_deadlock.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
semaphores_deadlock_pem4f.oem4f,copy : package/cfg/semaphores_deadlock_pem4f.oem4f
semaphores_deadlock_pem4f.sem4f,copy : package/cfg/semaphores_deadlock_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_semaphores_deadlock
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_semaphores_deadlock.tar.dep
endif
package/rel/xconfig_semaphores_deadlock/xconfig_semaphores_deadlock/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_semaphores_deadlock/xconfig_semaphores_deadlock/package/package.rel.xml: package/build.cfg
package/rel/xconfig_semaphores_deadlock/xconfig_semaphores_deadlock/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_semaphores_deadlock/xconfig_semaphores_deadlock/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_semaphores_deadlock.tar: package/rel/xconfig_semaphores_deadlock.xdc.inc package/rel/xconfig_semaphores_deadlock/xconfig_semaphores_deadlock/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_semaphores_deadlock.xdc.inc,package/rel/xconfig_semaphores_deadlock.tar.dep)


release release,xconfig_semaphores_deadlock: all xconfig_semaphores_deadlock.tar
clean:: .clean
	-$(RM) xconfig_semaphores_deadlock.tar
	-$(RM) package/rel/xconfig_semaphores_deadlock.xdc.inc
	-$(RM) package/rel/xconfig_semaphores_deadlock.tar.dep
